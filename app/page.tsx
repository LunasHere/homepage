...
export default function HomePage() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="w-full p-4 flex justify-end text-pink">
        <ThemeToggle />
      </header>

      <main className="flex-1 flex flex-col items-center justify-center p-6 text-pink">
        <div className="w-full max-w-md mx-auto text-center space-y-8">
          {/* Profile Image */}
          <div className="relative mx-auto w-32 h-32 rounded-full overflow-hidden border-4 border-background shadow-lg text-pink">
            <img src="/images/avatar.gif" alt="Avatar" className="w-full h-full object-cover" />
          </div>

          {/* Name & Title */}
          <div className="space-y-2">
            <h1 className="text-3xl font-bold text-pink">Luna</h1>
            <p>She/Her/Hers</p>
          ...
          {/* Social Links */}
          <div className="flex flex-col gap-3 pt-4 text-pink">
            <Link href="https://discord.gg/VWyrPVWnQ4" target="_blank" rel="noopener noreferrer">
              <Button variant="outline" className="w-full gap-2 text-left justify-start text-pink">
                <DiscordIcon className="h-5 w-5 text-pink" />
                <span>Discord</span>
      ...
      <footer className="py-6 text-center text-sm text-muted-foreground text-pink">
